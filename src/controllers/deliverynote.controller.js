...
export const signDeliveryNote = async (req, res, next) => {
  try {
    ...
    const signatureUpload = await uploadImage(req.file.buffer, 'signatures')
    const pdf = await generateDeliveryNotePdf(deliveryNote, signatureUpload.secure_url)
    const pdfUpload = await uploadPdf(pdf, 'pdfs')
...
export const downloadPdf = async (req, res, next) => {
  try {
    ...
    const pdf = await generateDeliveryNotePdf(deliveryNote, deliveryNote.signatureUrl)
